...
Graph.save_plot(folder_path=settings.output_path, file_name=settings.logged_hours_per_assignee_graph)
Graph.create_bar_chart(df = hour_user_df, x = settings.jira_assignee_col_name, y = settings.days_since_last_log_col_name)
Graph.save_plot(folder_path=settings.output_path, file_name=settings.days_since_last_log_per_user_graph)
...
Graph.save_plot(folder_path=settings.output_path, file_name=settings.issues_status_per_user_graph)
...
Graph.save_plot(folder_path=settings.output_path, file_name=settings.hours_and_count_per_status_graph)
